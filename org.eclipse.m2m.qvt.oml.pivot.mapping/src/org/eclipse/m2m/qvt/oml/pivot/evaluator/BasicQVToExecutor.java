...
//    }
	...
	private Variable getContextValueVariable(StandardLibraryInternal standardLibrary, ModelParameter typedModel) {
		// TODO Auto-generated method stub
		
		
		return null;
	}
	private Variable getContextVariable(StandardLibraryInternal standardLibrary,
			@NonNull OperationalTransformation transformation2) {
		// TODO Auto-generated method stub
		
		Variable ownedContext = transformation2.getOwnedVariable().get(0);
        if (ownedContext == null) {
        	ownedContext = PivotFactory.eINSTANCE.createVariable();
        	ownedContext.setName(transformation2.getName());
