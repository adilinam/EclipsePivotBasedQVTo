...
public abstract class AbstractQVToPivotVisitorImpl extends BasicEvaluationVisitor implements QVTOperationalVisitor<Object>
{
	...
	protected <T> @Nullable T doProcess(@Nullable Object astNode) {
		((Element) astNode).accept(this);
		return null;
	}
	 ...
	 * @return
	 */
	protected <T extends Element> @NonNull List<T> doProcessAll( /*@NonNull*/ Iterable<? extends EObject> astNodes) {

		for (Object astNode : astNodes) {
			T pivotElement = doProcess( astNode);
